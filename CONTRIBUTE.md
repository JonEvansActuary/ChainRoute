...
- **Code**: The JavaScript helpers in [docs/code](./docs/code) can be extended or ported. Reference implementations (e.g. other languages) may be added under a future `/reference-impl/` directory.
